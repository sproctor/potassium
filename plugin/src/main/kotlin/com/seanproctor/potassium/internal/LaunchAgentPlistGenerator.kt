...
internal object LaunchAgentPlistGenerator {
    ...
    private fun buildPlistXml(
        agent: LaunchAgentDefinition,
        resolvedBundleProgram: String,
    ): String =
        buildString {
    ...
    private fun StringBuilder.plistKey(
        key: String,
        value: String,
    ) {
    ...
    private fun StringBuilder.appendCalendarDict(
