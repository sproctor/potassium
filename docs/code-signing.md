...
|-----------------|-------------|
| `potassium.mac.notarization.appleID` | Apple ID email |
| `potassium.mac.notarization.password` | App-specific password |
| `potassium.mac.notarization.teamID` | Apple Team ID |
...
| Gradle property | Description |
|-----------------|-------------|
| `potassium.mac.notarization.keychainProfile` | Profile name created via `store-credentials` |
| `potassium.mac.notarization.keychainPath` | Optional path to the keychain holding the profile |
...
| Gradle property | Description |
|-----------------|-------------|
| `potassium.mac.notarization.apiKey` | Path to the `.p8` API key file |
| `potassium.mac.notarization.apiKeyId` | Key ID (the 10-character identifier) |
| `potassium.mac.notarization.apiIssuer` | Issuer UUID for the team |
